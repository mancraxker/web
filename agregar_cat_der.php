...
<div class="container">
	<h1>Nuevo Catedratico de Derecho</h1>
    <?php
    if(isset($_POST['enviar'])){  /* Verifica si el formulario fue enviado */
        ...
        $sql = "INSERT INTO catedraticos_der(nombre, app, apm, dir, num, col, telefono, mail)
                VALUES ('$nombre', '$app', '$apm', '$dir', '$num', '$col', '$telefono', '$mail')";
        
                // Verificar si el teléfono ya está registrado
        $sql_telefono = "SELECT * FROM catedraticos_der WHERE telefono = '$telefono'";
        ...
        if (mysqli_num_rows($resultado_telefono) > 0) {
            ...
            $sql_mail = "SELECT * FROM catedraticos_der WHERE mail = '$mail'";
    ...
    <td><input type="text" name="num" id="num" required />
        <span id="mensaje-error-numero" style="color:red; display:none;">El número de casa debe ser entre 1 y 3 dígitos o 'S/N'.</span>
            ...
            <div class="form-buttons">
                ...
                <input type="button" value="Ver lista" onclick="window.location.href='catedraticos_der.php';" />
