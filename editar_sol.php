...
<html>
<head>
    <title>EDITAR ALUMNOS DE SOCIALES</title>
    <style>
        body {
...
<body>
    ...
    if (isset($_POST['enviar'])) {
        ...
        $sql = "UPDATE sociales SET nombre='$nombre', app='$app', apm='$apm', dir='$dir', num='$num', col='$col', telefono='$telefono', mail='$mail', cuatrimestre='$cuatrimestre' WHERE id='$id'";
        ...
        if ($resultado) {
            ...
            echo "<script language='JavaScript'>
                     ...
                     location.assign('editar_sol.php');
                  </script>";
        }
        ...
        $id = $_GET['id'];
        $sql = "SELECT * FROM sociales WHERE id='$id'";
        $resultado = mysqli_query($conexion, $sql);
    ...
    <div class="form-container">
        ...
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
            ...
            <div class="button-container">
                ...
                <a href="sociales.php" class="button">REGRESAR</a>
            </div>
        </form>
    </div>
    <?php
