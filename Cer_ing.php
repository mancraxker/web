...
if (isset($_POST['enviar'])) {
    ...
    if (empty($nombre) && empty($telefono)) {
        echo "<script language='JavaScript'>
                ...
                location.assign('cer_ing.php');
              </script>";
    } else {
        // Inicia la consulta básica
        $sql = "SELECT * FROM ingenieria WHERE 1=1";
    ...
    <form method="POST" action="Cer_ing.php">
        <table>
            <tr>
                ...
                <td>
                    <a class="btn mostrar-todos" href="Cer_ing.php">Mostrar todos los alumnos</a>
                </td>
                <!-- Botón para generar certificados para todos los alumnos -->
            <td>
                <a href="Certificado_ing_todos.php?cuatrimestre=<?= $cuatrimestreSeleccionado ?>" class="btn" style="background-color: #28a745;">Generar Certificados por cuatrimestre</a>
            </td>
				
				<td>
                <a href="Certificado_ing_todos.php" class="btn" style="background-color: #28a745;">Generar Certificados para todos</a>
            </td>
            </tr>
        </table>
    </form>
            ...
            if ($resultado && mysqli_num_rows($resultado) > 0) {
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    echo "<tr>
                           ...
                           <td class='actions'>
                                <a href='Certificado_ing.php?id={$fila['id']}'>Generar Certificado</a>
                            </td>
                          </tr>";
                }
            } else {
