...
$sql = "SELECT * FROM catedraticos_sol";
...
if (isset($_POST['enviar'])) {
    ...
    if (empty($nombre) && empty($telefono)) {
        ...
        $sql = "SELECT * FROM catedraticos_sol WHERE 1=1";
...
<body>
    <div class="titulo-contenedor">
        <h1>Lista de Catedraticos - Sociales</h1>
        <a href="principal.php" title="Volver a la página inicial" class="home-link">
            <i class="fas fa-home"></i>
        </a>    
    </div>

    <form method="POST" action="catedraticos_sol.php">
        <table>
            <tr>
                <td>
                ...
                <td>
                    <a class="btn mostrar-todos" href="catedraticos_sol.php">Mostrar todos los catedraticos</a>
                </td>
                <td>
                    <a class="btn nuevo-alumno" href="agregar_cat_sol.php">Nuevo catedratico</a>
                </td>
            </tr>
        </table>
    </form>
            ...
            if ($resultado && mysqli_num_rows($resultado) > 0) {
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    echo "<tr>
                            ...
                            <td>{$fila['mail']}</td>
                            <td>
                                <a class='editar' href='editar_cat_sol.php?id={$fila['id']}'>EDITAR</a> - 
                                <a class='eliminar' href='eliminar_cat_sol.php?id={$fila['id']}'>ELIMINAR</a>
                            </td>
                          </tr>";
                }
            } else {
