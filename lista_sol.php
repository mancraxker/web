...
$query_catedratico = "SELECT id, nombre, app, apm FROM catedraticos_sol"; // Asegúrate de que el nombre de la tabla y columnas coincidan
...
<form method="GET" action="lista_sociales.php">
