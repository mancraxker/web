...
$query_catedratico = "SELECT nombre, app, apm FROM catedraticos_sol WHERE id = '$catedratico_id'";
...
$query = "SELECT id, nombre, app, apm FROM sociales WHERE cuatrimestre = '$cuatrimestre_id' ORDER BY nombre ASC";
...
$pdf->Cell(0, 10, "LICENCIATURA: SOCIALES", 0, 1, 'L');
