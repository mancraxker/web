...
<div class="container">
	<h1>Nuevo Catedratico de Sociales</h1>
    <?php
    if(isset($_POST['enviar'])){  /* Verifica si el formulario fue enviado */
        ...
        $sql = "INSERT INTO catedraticos_sol(nombre, app, apm, dir, num, col, telefono, mail)
                VALUES ('$nombre', '$app', '$apm', '$dir', '$num', '$col', '$telefono', '$mail')";
        
              // Verificar si el teléfono ya está registrado
        $sql_telefono = "SELECT * FROM catedraticos_sol WHERE telefono = '$telefono'";
        ...
        if (mysqli_num_rows($resultado_telefono) > 0) {
            ...
            $sql_mail = "SELECT * FROM catedraticos_sol WHERE mail = '$mail'";
            ...
            if (mysqli_num_rows($resultado_mail) > 0) {
                ...
                if ($resultado) {
                    echo "<script language='JavaScript'>
                            ...
                            location.assign('catedraticos_sol.php');
                          </script>";
                } else {
                    echo "<script language='JavaScript'>
    ...
    <td><input type="text" name="num" id="num" required />
        <span id="mensaje-error-numero" style="color:red; display:none;">El número de casa debe ser entre 1 y 3 dígitos o 'S/N'.</span>
			...
			<input type="submit" name="enviar" value="Agregar catedratico" />
			
            <div class="form-buttons">
                <input type="reset" value="Cancelar">
                <input type="button" value="Ver lista" onclick="window.location.href='catedraticos_sol.php';" />
