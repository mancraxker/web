...
<div class="container">
    ...
    if(isset($_POST['enviar'])){  /* Verifica si el formulario fue enviado */
        ...
        $sql = "INSERT INTO derecho(nombre, app, apm, dir, num, col, telefono, mail, cuatrimestre)
                VALUES ('$nombre', '$app', '$apm', '$dir', '$num', '$col', '$telefono', '$mail', '$cuatrimestre')";
        
               // Verificar si el teléfono ya está registrado
        $sql_telefono = "SELECT * FROM derecho WHERE telefono = '$telefono'";
        ...
        if (mysqli_num_rows($resultado_telefono) > 0) {
            ...
            $sql_mail = "SELECT * FROM derecho WHERE mail = '$mail'";
    ...
    ?>
        <form action="<?=$_SERVER['PHP_SELF']?>" method="post">  <!-- Inicia el formulario -->
            ...
            <div class="form-buttons">
                ...
                <input type="button" value="Ver lista" onclick="window.location.href='derecho.php';" />
