...
if (isset($_POST['enviar'])) {
    ...
    if (empty($nombre) && empty($telefono)) {
        ...
        $sql = "SELECT * FROM sociales WHERE 1=1";
    ...
    <form method="POST" action="Cer_sol.php">
        <table>
            <tr>
                ...
                <td>
                    <a class="btn mostrar-todos" href="Cer_sol.php">Mostrar todos los alumnos</a>
                </td>
               	 <!-- Botón para generar certificados para todos los alumnos -->
            <td>
                <a href="Certificado_sol_todos.php?cuatrimestre=<?= $cuatrimestreSeleccionado ?>" class="btn" style="background-color: #28a745;">Generar Certificados por cuatrimestre</a>
            </td>
				
				<td>
                <a href="Certificado_sol_todos.php" class="btn" style="background-color: #28a745;">Generar Certificados para todos</a>
            </td>
            </tr>
        </table>
    </form>
            ...
            if ($resultado && mysqli_num_rows($resultado) > 0) {
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    echo "<tr>
                           ...
                           <td class='actions'>
                                <a href='Certificado_sol.php?id={$fila['id']}'>Generar Certificado</a>
                            </td>
                          </tr>";
                }
            } else {
