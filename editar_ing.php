...
<body>
    ...
    if (isset($_POST['enviar'])) {
        ...
        $sql = "UPDATE ingenieria SET nombre='$nombre', app='$app', apm='$apm', dir='$dir', num='$num', col='$col', telefono='$telefono', mail='$mail', cuatrimestre='$cuatrimestre' WHERE id='$id'";
        ...
        if ($resultado) {
            ...
            echo "<script language='JavaScript'>
                     ...
                     location.assign('editar_ing.php');
                  </script>";
        }
        ...
        $id = $_GET['id'];
        $sql = "SELECT * FROM ingenieria WHERE id='$id'";
        $resultado = mysqli_query($conexion, $sql);
    ...
    <div class="form-container">
        ...
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
            ...
            <div class="button-container">
                ...
                <a href="ingenieria.php" class="button">REGRESAR</a>
            </div>
        </form>
    </div>
    <?php
