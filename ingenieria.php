...
<body>
    <div class="titulo-contenedor">
        <h1>Lista de alumnos de Ingeniería</h1>
        <a href="principal.php" title="Volver a la página inicial" class="home-link">
            <i class="fas fa-home"></i>
        </a>    
    </div>

    <form method="POST" action="ingenieria.php">
        <table>
            <tr>
                <td>
                ...
                <td>
                    <a class="btn mostrar-todos" href="ingenieria.php">Mostrar todos los alumnos</a>
                </td>
                <td>
                    <a class="btn nuevo-alumno" href="agregar_ing.php">Nuevo alumno</a>
                </td>
            </tr>
        </table>
    </form>
            ...
            if ($resultado && mysqli_num_rows($resultado) > 0) {
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    echo "<tr>
                            ...
                            <td>
                                <a class='editar' href='editar_ing.php?id={$fila['id']}'>EDITAR</a> - 
                                <a class='eliminar' href='eliminar_ing.php?id={$fila['id']}'>ELIMINAR</a>
                            </td>
                          </tr>";
                }
            } else {
