...
<body>
    ...
    if (isset($_POST['enviar'])) {
        ...
        $sql = "UPDATE catedraticos_der SET nombre='$nombre', app='$app', apm='$apm', dir='$dir', num='$num', col='$col', telefono='$telefono', mail='$mail' WHERE id='$id'";
        ...
        $id = $_GET['id'];
        $sql = "SELECT * FROM catedraticos_der WHERE id='$id'";
        $resultado = mysqli_query($conexion, $sql);
    ...
    <div class="form-container">
        ...
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
            ...
            <div class="button-container">
                ...
                <a href="catedraticos_der.php" class="button">REGRESAR</a>
            </div>
        </form>
    </div>
    <?php
