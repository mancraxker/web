...
<body>
    ...
    <form method="POST" action="sociales.php">
        <table>
            <tr>
                ...
                <td>
                    <a class="btn mostrar-todos" href="sociales.php">Mostrar todos los alumnos</a>
                </td>
                <td>
                    <a class="btn nuevo-alumno" href="agregar_sol.php">Nuevo alumno</a>
                </td>
    ...
    <form method="GET" action="">
        <label for="cuatrimestre">Selecciona Cuatrimestre:</label>
            ...
            if ($resultado && mysqli_num_rows($resultado) > 0) {
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    echo "<tr>
                            ...
                            <td>
                                <a class='editar' href='editar_sol.php?id={$fila['id']}'>EDITAR</a> - 
                                <a class='eliminar' href='eliminar_sol.php?id={$fila['id']}'>ELIMINAR</a>
                            </td>
                          </tr>";
                }
            } else {
