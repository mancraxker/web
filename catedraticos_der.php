...
$sql = "SELECT * FROM catedraticos_der";
...
if (isset($_POST['enviar'])) {
    ...
    if (empty($nombre) && empty($telefono)) {
        ...
        $sql = "SELECT * FROM catedraticos_der WHERE 1=1";
...
<body>
    <div class="titulo-contenedor">
        <h1>Lista de Catedraticos - Derecho</h1>
        <a href="principal.php" title="Volver a la página inicial" class="home-link">
            <i class="fas fa-home"></i>
        </a>    
    </div>

    <form method="POST" action="catedraticos_der.php">
        <table>
            <tr>
                <td>
                ...
                <td>
                    <a class="btn mostrar-todos" href="catedraticos_der.php">Mostrar todos los catedraticos</a>
                </td>
                <td>
                    <a class="btn nuevo-alumno" href="agregar_cat_der.php">Nuevo catedratico</a>
                </td>
            </tr>
        </table>
    </form>
            ...
            if ($resultado && mysqli_num_rows($resultado) > 0) {
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    echo "<tr>
                            ...
                            <td>{$fila['mail']}</td>
                            <td>
                                <a class='editar' href='editar_cat_der.php?id={$fila['id']}'>EDITAR</a> - 
                                <a class='eliminar' href='eliminar_cat_der.php?id={$fila['id']}'>ELIMINAR</a>
                            </td>
                          </tr>";
                }
            } else {
