...
<div class="container">
	<h1>Nuevo Catedratico de ingenieria</h1>
    <?php
    if(isset($_POST['enviar'])){  /* Verifica si el formulario fue enviado */
        ...
        $sql = "INSERT INTO catedraticos(nombre, app, apm, dir, num, col, telefono, mail)
                VALUES ('$nombre', '$app', '$apm', '$dir', '$num', '$col', '$telefono', '$mail')";
        
           // Verificar si el teléfono ya está registrado
        $sql_telefono = "SELECT * FROM catedraticos WHERE telefono = '$telefono'";
        ...
        if (mysqli_num_rows($resultado_telefono) > 0) {
            ...
            $sql_mail = "SELECT * FROM catedraticos WHERE mail = '$mail'";
            ...
            if (mysqli_num_rows($resultado_mail) > 0) {
                ...
                if ($resultado) {
                    echo "<script language='JavaScript'>
                            ...
                            location.assign('catedraticos.php');
                          </script>";
                } else {
                    echo "<script language='JavaScript'>
    ...
    <td><input type="text" name="num" id="num" required />
        <span id="mensaje-error-numero" style="color:red; display:none;">El número de casa debe ser entre 1 y 3 dígitos o 'S/N'.</span>
            ...
            <div class="form-buttons">
                ...
                <input type="button" value="Ver lista" onclick="window.location.href='catedraticos.php';" />
