    ...
    <form method="POST" action="derecho.php">
        <table>
            <tr>
                ...
                <td>
                    <a class="btn mostrar-todos" href="derecho.php">Mostrar todos los alumnos</a>
                </td>
                <td>
                    <a class="btn nuevo-alumno" href="agregar_der.php">Nuevo alumno</a>
                </td>
            </tr>
        </table>
    </form>
            ...
            if ($resultado && mysqli_num_rows($resultado) > 0) {
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    echo "<tr>
                            ...
                            <td>
                                <a class='editar' href='editar_der.php?id={$fila['id']}'>EDITAR</a> - 
                                <a class='eliminar' href='eliminar_der.php?id={$fila['id']}'>ELIMINAR</a>
                            </td>
                          </tr>";
                }
            } else {
