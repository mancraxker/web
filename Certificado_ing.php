...
// Función para agregar el texto al PDF
...
$sql = "SELECT ingenieria.nombre AS ingenieria, ingenieria.app AS appe, ingenieria.apm AS apme 
        FROM ingenieria 
        WHERE ingenieria.id = $id";
...
$nombreCompleto = $datos['ingenieria'] . ' ' . $datos['appe'] . ' ' . $datos['apme'];
