...
$query_catedratico = "SELECT nombre, app, apm FROM catedraticos_der WHERE id = '$catedratico_id'";
...
$query = "SELECT id, nombre, app, apm FROM derecho WHERE cuatrimestre = '$cuatrimestre_id' ORDER BY nombre ASC";
...
$pdf->Cell(0, 10, "LICENCIATURA: DERECHO", 0, 1, 'L');
